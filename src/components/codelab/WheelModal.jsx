...
function WheelModal({ show, onHide }) {
  useEffect(() => {
  ...
  return (
    <Modal show={show} onHide={onHide} size="xl">
      <Modal.Header closeButton>
        <Modal.Title>Picker Wheel</Modal.Title>
        <div className="custom-control custom-switch d-none d-sm-inline">
          <span className="me-2">Danh sách:</span>
          <input
            type="radio"
            ...
            checked
          />
          <label className="custom-control-label me-2" for="select-online">
            Online
          </label>
          ...
          <input
            ...
            id="select-name"
          />
          <label className="custom-control-label me-2" for="select-name">
            Họ tên
          </label>
          ...
          <input
            ...
            id="select-email"
          />
          <label className="custom-control-label me-2" for="select-email">
            Email
          </label>
        </div>
      </Modal.Header>
